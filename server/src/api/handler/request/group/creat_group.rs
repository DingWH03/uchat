...
use crate::{protocol::{request::{CreateGroupRequest, RequestResponse}, Empty}, server::AppState};
...
pub async fn handle_creat_group(
    ...
    request_lock.create_group(user_id,&payload.group_name, payload.members).await.into_response()
}